...
def nested_pynisher(level=2, cputime=5, walltime=5, memlimit=10e24, increment=-1, grace_period=1):
    ...
    if level == 0:
        ...
        func = pynisher2.enforce_limits(mem_in_mb=memlimit, cpu_time_in_s=cputime, wall_time_in_s=walltime,
...
class test_limit_resources_module(unittest.TestCase):
    ...
    def test_high_cpu_percentage(self):
        ...
        cpu_time_in_s = 2
        grace_period = 1
        wrapped_function = pynisher2.enforce_limits(cpu_time_in_s=cpu_time_in_s, grace_period_in_s=grace_period)(
            cpu_usage)
    ...
    def test_liblinear_svc(self):
        ...
        wrapped_function = pynisher2.enforce_limits(cpu_time_in_s=time_limit, mem_in_mb=None,
    ...
    def test_capture_output(self):
        ...
        wrapped_function = pynisher2.enforce_limits(wall_time_in_s=time_limit, mem_in_mb=None,
